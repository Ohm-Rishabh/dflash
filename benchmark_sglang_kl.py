...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Override the number of draft tokens (block size) for DFlash. Default: use the draft model's built-in block_size.",
    )
        ...
        dflash_proc = popen_launch_server(
            ...
            other_args=[
                ...
                *([
                ...
                ] if args.speculative_num_draft_tokens is not None else []),
            ],
        )
        try:
            _send_generate(
